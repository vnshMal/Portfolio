      ...
      <div className="hero-container animate-on-scroll visible">
        ...
        <div className="hero-left">
          ...
          <p className="hero-description">
            I build secure, scalable, and high-performance backend systems—from robust Spring Boot APIs to event-driven microservices that keep applications safe, fast, and reliable.
          </p>
          ...
          <div className="hero-actions">
            ...
            <a href="https://wa.me/your-number" target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp">
        ...
        <div className="hero-right">
          <div className="profile-card-wrapper">
            ...
            <div className="floating-badge badge-top-left glass-badge">
              ...
              <span className="badge-desc">Security & Dev</span>
            </div>
            ...
            <div className="profile-image-card">
              ...
              <div className="profile-card-footer">
                <div className="footer-details">
                  ...
                  <p className="footer-title">Cybersecurity & Backend • UPES</p>
